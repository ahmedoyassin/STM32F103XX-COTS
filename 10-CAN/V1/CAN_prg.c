...
void CAN_voidRecieveMsg(u32 local_u8RxFifo, CAN_RxHeaderTypeDef *pRxHeader, u8 Local_u8Data[])
{
    ...
    pRxHeader->TimeStamp = CAN->RDT0R.B.TIME;
		...
		for(u8 i=0 ; i < pRxHeader->DLC ; i++)
		{
			...
			{
			case 0:
				Local_u8Data[i] = (u8)((CAN->RDL0R.B.DATA0));
				break;
			case 1:
				Local_u8Data[i] = (u8)((CAN->RDL0R.B.DATA1));
				break;
			case 2:
				Local_u8Data[i] = (u8)((CAN->RDL0R.B.DATA2));
				break;
			case 3:
				Local_u8Data[i] = (u8)((CAN->RDL0R.B.DATA3));
				break;
			case 4:
				Local_u8Data[i] = (u8)((CAN->RDH0R.B.DATA4));
				break;
			case 5:
				Local_u8Data[i] = (u8)((CAN->RDH0R.B.DATA5));
				break;
			case 6:
				Local_u8Data[i] = (u8)((CAN->RDH0R.B.DATA6));
				break;
			case 7:
				Local_u8Data[i] = (u8)((CAN->RDH0R.B.DATA7));
				break;
			}
		}
	}
	else
	{
	    ...
	    pRxHeader->TimeStamp = CAN->RDT1R.B.TIME;
			...
			for(u8 i=0 ; i < pRxHeader->DLC ; i++)
			{
				...
				{
				case 0:
					Local_u8Data[i] = (u8)((CAN->RDL1R.B.DATA0));
					break;
				case 1:
					Local_u8Data[i] = (u8)((CAN->RDL1R.B.DATA1));
					break;
				case 2:
					Local_u8Data[i] = (u8)((CAN->RDL1R.B.DATA2));
					break;
				case 3:
					Local_u8Data[i] = (u8)((CAN->RDL1R.B.DATA3));
					break;
				case 4:
					Local_u8Data[i] = (u8)((CAN->RDH1R.B.DATA4));
					break;
				case 5:
					Local_u8Data[i] = (u8)((CAN->RDH1R.B.DATA5));
					break;
				case 6:
					Local_u8Data[i] = (u8)((CAN->RDH1R.B.DATA6));
					break;
				case 7:
					Local_u8Data[i] = (u8)((CAN->RDH1R.B.DATA7));
					break;
				}
			}
